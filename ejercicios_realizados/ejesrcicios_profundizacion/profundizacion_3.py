...
'''
def comprension_dataset(producto, lista_compra_id):
    ...
    for x in lista_compra_id:
        i +=1
        if x in producto:
            print ('El artículo que compró tiene el código' , x,' con descripción:' ,producto[x])
...
if __name__ == '__main__':
    ...
    comprension_dataset(producto, lista_compra_id)
