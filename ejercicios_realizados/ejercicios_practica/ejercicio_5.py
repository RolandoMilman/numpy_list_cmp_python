...
if __name__ == '__main__':
    ...
    print('Listado total de accesos:', accesos )
    ...
    lista = [x for x in accesos if(x>=1 and x<=10) == True]
    # lista [2, 4, 6, 8]
    print('Personal con ID del 1 al 10 que pasaron por el molinete',lista)
    ...
    print('Listado de ID válidos:', id_validos )
    ...
    # personal_valido = [.....]
    # Método con comprensión de listas
    personal_valido = [x for x in accesos if(x in id_validos) == True]
    # lista [2, 4, 6, 8]
    print('Personal válido que pasó por el molinete',personal_valido)
